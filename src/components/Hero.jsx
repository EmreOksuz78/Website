      ...
      <div className='flex flex-wrap'> 
        <div className='w-full lg:w-1/2'>
            <div className='flex flex-col items-center lg:items-start'>
                ...
                initial="hidden"
                animate="visible"
                className='pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-5xl'>Emre Öksüz</motion.h1>
                <motion.span
                variants={container(0.5)}
                initial="hidden"
                animate="visible"
                className='bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-4xl tracking-tight
                text-transparent'>Android Developer</motion.span>
        ...
        <div className='flex justify-center'>
            ...
            transition={{duration:1,delay:1.2}} src={profilePhoto} alt='' />
        </div>
        </div>
      </div>
    </div>
